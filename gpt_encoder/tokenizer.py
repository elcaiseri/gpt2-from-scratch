...
class GPT2Tokenizer:
    ...
    def from_pretrained(cls, model_name_or_path):
        if model_name_or_path != "gpt2":
            raise ValueError(
                f"Only 'gpt2' is supported, but got '{model_name_or_path}'."
            )
...
if __name__ == "__main__":
    ...
    merge_dir = os.path.join(os.path.dirname(__file__), "merges.txt")

    tokenizer = GPT2Tokenizer(vocab_dir, merge_dir)
